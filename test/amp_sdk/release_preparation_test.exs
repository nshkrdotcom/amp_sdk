defmodule AmpSdk.ReleasePreparationTest do
  ...
  test "package and HexDocs expose only public release presentation files" do
    ...
    assert project[:docs][:source_ref] == "v0.9.0"
  ...
  test "README has the centered 200px logo and GitHub and MIT badges" do
    ...
    assert header =~ ~s(src="assets/amp_sdk.svg")
    assert header =~ ~s(width="200")
    assert header =~ ~s(href="https://github.com/nshkrdotcom/amp_sdk")
